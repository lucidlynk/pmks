...
class PsksSubmissionPolicy
{
    ...
    public function view(User $user, PsksSubmission $submission): bool
    {
    ...
    public function update(User $user, PsksSubmission $submission): bool
    {
    ...
    public function delete(User $user, PsksSubmission $submission): bool
    {
        if (!$submission->batch?->canBeEdited()) return false;
